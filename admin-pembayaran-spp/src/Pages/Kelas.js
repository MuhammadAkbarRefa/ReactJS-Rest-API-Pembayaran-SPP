...
export default class Kelas extends React.Component {
    ...
    saveKelas = event => {
        ...
        form1.append("nama_kelas", this.state.nama_kelas)
        form1.append("kompetensi_keahlian", this.state.kompetensi_keahlian)

        console.log(this.state.nama_kelas)
        console.log(this.state.kompetensi_keahlian)
        console.log(form1)

        let url = base_url + "/kelas"
        if (this.state.action === "insert") {
            axios.post(url, form1, this.headerConfig())
            .then(response => {
            ...
            axios.put(url, form1, this.headerConfig())
            .then(response => {
                window.alert(response.data.message)
                this.getKelas()
            })
            ...
            <div className="kelas">
                ...
                <div className="container">
                    <div className="card-header">
                        <h3 className="text-center text-bold text-info mt-2"> Kelas List 3</h3>
